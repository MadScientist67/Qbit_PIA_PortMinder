...
$qbit_host     = "http://192.168.27.16:8080"       # Change if using remote host
$qbit_username = "MadScientist"                       # Your WebUI username
$qbit_password = "4rShmA5CQ9vTs2"                  # Your WebUI password
